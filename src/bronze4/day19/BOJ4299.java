...
// 두 팀이 공식 경기에서 만나려면 FA Cup밖에 기회가 없었다.
...
public class BOJ4299 {
    public static void main(String[] args) {
        ...
        if (sum < difference) {
            ...
            int win = (sum + difference) / 2;
            int lose = sum - win;
            if (win + lose == sum && win - lose == difference) {
                System.out.println(win + " " + lose);
            } else {  // 예제 입력이 2 1 일 경우 축구 점수가 소수인 경우가 발생. 예외처리 필요
                System.out.println(-1);
            }
        }
    }
