...
// 이 과정을 계속 반복해보면 출력되는 에는 반복되는 부분이 있다.
// 예를 들어서, N = 67, P = 31인 경우를 생각해보자.
// 처음 출력되는 수는 67이고, 두 번째로 출력되는 수는 67×67 = 4489를 31로 나눈 나머지 25이다.
...
// https://upload.acmicpc.net/93c5a6ec-3c50-4f42-a15b-832f719c0be6/-/preview/
// 즉 이 과정을 반복하면, 처음 67을 제외하면 3개의 수 25, 1, 5가 계속 무한히 반복되게 된다.
...
// 입력 : 첫째 줄에 처음 시작하는 두 자연수 N과 P가 공백을 사이에 두고 주어진다.
// 출력 : 첫째 줄에 반복되는 부분에 포함된 서로 다른 수의 개수를 출력한다.
// 제한 :
// 1 ≤ N ≤ 1,000
// 2 ≤ P ≤ 97
// 예제 입력 : 67 31
