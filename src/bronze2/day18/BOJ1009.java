...
public class BOJ1009 {
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < T; i++) {
            int a = sc.nextInt();
            int b = sc.nextInt();
            BigInteger cnt = BigInteger.valueOf(a).pow(b);
            if(cnt.mod(BigInteger.TEN).equals(BigInteger.ZERO)) {
                System.out.println(10);
            } else {
                System.out.println(cnt.mod(BigInteger.TEN));
            }
        }
